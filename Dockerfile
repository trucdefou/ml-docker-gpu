...
RUN apt-get update && apt-get install -y build-essential git bash-completion python3-pip wget autoconf libtool unzip curl vim libpng-dev
RUN apt-get update && apt-get install -y procps lsb-release gnupg
